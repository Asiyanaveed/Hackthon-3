            ...
            <section>
              ...
              <div className="space-y-4 text-base">
                ...
                <ul className="list-none space-y-2 pl-4">
                  ...
                  <li>If you enter your PAN information at checkout, youll be able to pay for your order with PayTM or a local credit or debit card.</li>
                  <li>Apple Pay</li>
                </ul>
              </div>

              <div className="my-8">
                <p className="mb-4 font-medium">Nike Members can store multiple debit or credit cards in their profile for faster checkout. If youre not already a Member, join us today.</p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p>To see Apple Pay as an option in the Nike App or on Nike.com, youll need to use a compatible Apple device running the latest OS, be signed in to your iCloud account and have a supported card in your Wallet. Additionally, you&apos;ll need to use Safari to use Apple Pay on Nike.com.</p>
                  </div>
                </div>
              </div>
            </section>
